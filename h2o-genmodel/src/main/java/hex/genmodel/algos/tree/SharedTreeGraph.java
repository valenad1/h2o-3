...
public class SharedTreeGraph {
  ...
  /**
   * Print graph output in a format readable by dot (graphviz or graphstream).
   ...
   */
  public void printDot(PrintStream os, int maxLevelsToPrintPerEdge, boolean detail, String optionalTitle, PrintMojo.PrintTreeOptions treeOptions, boolean graphstreamCustom) {
    os.println("/*");
    ...
    for (SharedTreeSubgraph sg : subgraphArray) {
      sg.printDot(os, maxLevelsToPrintPerEdge, detail, optionalTitle, treeOptions, graphstreamCustom);
    }
    os.println("");
    os.println("}");
    os.println("");
